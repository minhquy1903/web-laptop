		...
		<form className='register-container'>
			<div className='input-element'>
				...
				<input
					...
					name='username'
					id='username-text-register'
					onChange={(e) => handleChange(e)}
				/>
				{formErrors.username.length > 0 && (
					<span
						className='error-message'
						id='error-message-username-test-register'
					>
						{formErrors.username}
					</span>
				)}
			...
			<div className='input-element'>
				...
				<input
					...
					name='email'
					placeholder='email'
					id='email-text-register'
					onChange={(e) => handleChange(e)}
				/>
				{formErrors.email.length > 0 && (
					<span
						className='error-message'
						id='error-message-email-test-register'
					>
						{formErrors.email}
					</span>
				)}
			...
			<div className='input-element'>
				...
				<input
					...
					name='password'
					id='password-text-register'
					onChange={(e) => handleChange(e)}
				/>
				{formErrors.password.length > 0 && (
					<span className='error-message' id='error-message-pass-test-register'>
						{formErrors.password}
					</span>
				)}
			</div>
